...
import { UserSchemaType } from '~/features/account/User';
import { IDatabase } from '~/features/database/IDatabase';
import { Filters, FiltersSchemaType } from '~/features/directory/Filters';
import { IndexLetterSchemaType } from '~/features/directory/IndexLetter';
import { ListingSchemaType } from '~/features/directory/Listing';
import { TagSchemaType } from '~/features/directory/Tag';
 ...
 * Class
 */
export class SurrealAdapter implements IDatabase {
